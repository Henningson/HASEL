...
class PointShower(zoomableVideo.ZoomableVideo):
    ...
    def __init__(
        ...
        super(PointShower, self).__init__(video, parent)
    ...
    def enterEvent(self, event):
        super(PointShower, self).enterEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

    def mouseReleaseEvent(self, event):
        super(PointShower, self).mouseReleaseEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

...
class PointClickerCotracker(zoomableVideo.ZoomableVideo):
    ...
    def __init__(
        ...
        super(PointClickerCotracker, self).__init__(video, parent)
    ...
    def mousePressEvent(self, event) -> None:
        if (
            ...
            super(PointClickerCotracker, self).mousePressEvent(event)
    ...
    def enterEvent(self, event):
        super(PointClickerCotracker, self).enterEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

    def mouseReleaseEvent(self, event):
        super(PointClickerCotracker, self).mouseReleaseEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

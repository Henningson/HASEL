...
class PointClicker(zoomableVideo.ZoomableVideo):
    ...
    def __init__(
        ...
        super(PointClicker, self).__init__(video, parent)
    ...
    def mousePressEvent(self, event) -> None:
        if (
            ...
            super(PointClicker, self).mousePressEvent(event)
    ...
    def enterEvent(self, event):
        super(PointClicker, self).enterEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

    def mouseReleaseEvent(self, event):
        super(PointClicker, self).mouseReleaseEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

...
import VFLabel.gui_graphics_view.segmentationOverlay as segmentationOverlay


class SegmentationOverlayWithGlottalMidline(segmentationOverlay.SegmentationOverlay):
    def __init__(
        self,
        images: List[QImage],
        ...
        super(SegmentationOverlayWithGlottalMidline, self).__init__(

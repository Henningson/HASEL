...
import VFLabel.gui_graphics_view.segmentationOverlayWithGlottalMidline
...
from VFLabel.gui_dialog.progress import ProgressDialog
...
class GlottisSegmentationView(QWidget):
    def __init__(self, project_path: str, video: np.array, parent=None):
        ...
        self.video_view = VFLabel.gui_graphics_view.zoomableVideo.ZoomableVideo(qvideo)
        self.segmentation_view = VFLabel.gui_graphics_view.DrawableSegmentation(
            qvideo_segmentations if self.segmentations else None,
            project_path,
            self,
        )
        self.overlay_view = VFLabel.gui_graphics_view.segmentationOverlayWithGlottalMidline.SegmentationOverlayWithGlottalMidline(

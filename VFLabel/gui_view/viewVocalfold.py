...
class VocalfoldSegmentationView(QWidget):
    ...
    def __init__(self, project_path: str, video: np.array, parent=None):
        ...
        self.draw_view = (
            VFLabel.gui_graphics_view.segmentationDrawer.SegmentationDrawer(
        ...
        self.move_view = VFLabel.gui_graphics_view.transformableSegmentation.TransformableSegmentation(
            self.qvideo[-1], None
        )

        # right window (current frame and interpolation window)
        self.interpolate_view = (
            VFLabel.gui_graphics_view.interpolateSegmentation.InterpolateSegmentation(
        ...
        self.segment_slider = (
            VFLabel.gui_widgets.vfSegmentationSlider.VocalfoldSegmentationSliderWidget(
    ...
    def save(self) -> None:
        ...
        for i in VFLabel.gui_dialog.progress.ProgressDialog(

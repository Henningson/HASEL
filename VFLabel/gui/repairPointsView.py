...
import VFLabel.gui.repairPointWidget
...
class PointLabelingWidget(QWidget):
    def __init__(
        ...
        self.point_clicker_widget = VFLabel.gui.repairPointWidget.RepairPointWidget(
        ...
        self.button_remove = QPushButton("Remove Point for Laserbeam")
        ...
        self.point_clicker_widget.point_added.connect(self.increment_frame)

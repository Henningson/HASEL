...
class RepairPointWidget(videoViewWidget.VideoViewWidget):
    ...
    def __init__(
        ...
        super(RepairPointWidget, self).__init__(video, parent)
    ...
    def mousePressEvent(self, event) -> None:
        if (
            ...
            super(RepairPointWidget, self).mousePressEvent(event)
    ...
    def enterEvent(self, event):
        super(RepairPointWidget, self).enterEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))

    def mouseReleaseEvent(self, event):
        super(RepairPointWidget, self).mouseReleaseEvent(event)
        self.setCursor(QCursor(PyQt5.QtCore.Qt.CrossCursor))
